        ...
        <div class="my-0 mx-auto px-8 max-w-7xl text-left">
            ...
            <nav class="py-2 px-4 text-lg font-medium h-12 bg-customBlue flex items-center justify-between">
                <a href="/console" class="flex items-left">
                    <img src="/lumni-logo-sm.png" alt="lumni Logo" class="h-6 mr-1 mt-1" />
                    <div class="text-2xl font-mono font-light text-white inline-block text-transparent bg-clip-text tracking-widest">Lumni</div>
                </a>
