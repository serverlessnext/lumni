...
impl Configurations {
    ...
    pub async fn load(
        ...
        let password = meta.get("__PASSWD__").ok_or(
...
mod tests {
    ...
    async fn test_save_and_load() {
        ...
        let load_result = configurations.load(&secure_storage, form_id).await;
        assert!(
            load_result.is_ok(),
    ...
    async fn test_add_and_delete() {
        ...
        let delete_result =
            configurations.delete(&mut secure_storage, form_id).await;
        assert!(
            delete_result.is_ok(),
